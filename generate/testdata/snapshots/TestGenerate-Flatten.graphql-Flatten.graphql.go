...
type InnerQueryFragment struct {
	RandomVideo VideoFields        `js:"randomVideo" json:"randomVideo"`
	RandomItem  ContentFields      `js:"randomItem" json:"-"`
	OtherVideo  ContentFieldsVideo `js:"otherVideo" json:"otherVideo"`
}
...
type VideoFields struct {
	// ID is documented in the Content interface.
	Id     testutil.ID            `js:"id" json:"id"`
	Parent VideoFieldsParentTopic `js:"parent" json:"parent"`
}
...
type VideoFieldsParentTopic struct {
	VideoChildren []ChildVideoFields `js:"videoChildren" json:"videoChildren"`
}
