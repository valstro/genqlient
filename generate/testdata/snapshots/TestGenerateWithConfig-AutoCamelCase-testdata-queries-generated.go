...
type SnakeCaseFieldsResponse struct {
	...
	User SnakeCaseFieldsUser `js:"user" json:"user"`
}
...
type SnakeCaseFieldsUser struct {
	UserId      string `js:"user_id" json:"user_id"`
	DisplayName string `js:"display_name" json:"display_name"`
}
...
type SnakeCaseTypeResponse struct {
	SnakeCaseType SnakeCaseTypeSnakeCaseType `js:"snake_case_type" json:"snake_case_type"`
}
