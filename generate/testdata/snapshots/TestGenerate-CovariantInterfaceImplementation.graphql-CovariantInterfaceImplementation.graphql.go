...
type ContentFieldsArticle struct {
	Next    ContentFieldsNextContent      `js:"next" json:"-"`
	Related []ContentFieldsRelatedContent `js:"related" json:"-"`
}
...
type CovariantInterfaceImplementationRandomItemArticle struct {
	...
	// ID is the identifier of the content.
	Id      testutil.ID                                                       `js:"id" json:"id"`
	Next    CovariantInterfaceImplementationRandomItemContentNextContent      `js:"next" json:"-"`
	Related []CovariantInterfaceImplementationRandomItemContentRelatedContent `js:"related" json:"-"`
}
...
type CovariantInterfaceImplementationResponse struct {
	RandomItem CovariantInterfaceImplementationRandomItemContent `js:"randomItem" json:"-"`
	Root       CovariantInterfaceImplementationRootTopic         `js:"root" json:"root"`
}
...
type CovariantInterfaceImplementationRootTopic struct {
	ContentFieldsTopic `js:"" json:"-"`
	TopicFields        `js:"" json:"-"`
	Next               CovariantInterfaceImplementationRootTopicNextTopic      `js:"next" json:"next"`
	Related            []CovariantInterfaceImplementationRootTopicRelatedTopic `js:"related" json:"related"`
}
...
type TopicFields struct {
	Next    TopicFieldsNextTopic      `js:"next" json:"next"`
	Related []TopicFieldsRelatedTopic `js:"related" json:"related"`
}
