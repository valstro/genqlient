...
type ComplexNamedFragmentsWithInlineUnionResponse struct {
	...
	User ComplexNamedFragmentsWithInlineUnionUser      `js:"user" json:"user"`
	Root ComplexNamedFragmentsWithInlineUnionRootTopic `js:"root" json:"root"`
}
...
type InnerQueryFragment struct {
	RandomItem InnerQueryFragmentRandomItemContent     `js:"randomItem" json:"-"`
	RandomLeaf InnerQueryFragmentRandomLeafLeafContent `js:"randomLeaf" json:"-"`
	OtherLeaf  InnerQueryFragmentOtherLeafLeafContent  `js:"otherLeaf" json:"-"`
}
...
type InnerQueryFragmentOtherLeafVideo struct {
	Typename           string `js:"__typename" json:"__typename"`
	MoreVideoFields    `js:"" json:"-"`
	ContentFieldsVideo `js:"" json:"-"`
}
...
type MoreVideoFields struct {
	...
	Id     *testutil.ID                `js:"id" json:"id"`
	Parent *MoreVideoFieldsParentTopic `js:"parent" json:"parent"`
}
...
type MoreVideoFieldsParentTopic struct {
	...
	Url                *string `js:"url" json:"url"`
	ContentFieldsTopic `js:"" json:"-"`
	Children           []MoreVideoFieldsParentTopicChildrenContent `js:"children" json:"-"`
}
...
type TopicNewestContent struct {
	NewestContent TopicNewestContentNewestContentLeafContent `js:"newestContent" json:"-"`
}
...
type TopicNewestContentNewestContentArticle struct {
	Typename                 string `js:"__typename" json:"__typename"`
	SimpleLeafContentArticle `js:"" json:"-"`
}
...
type TopicNewestContentNewestContentVideo struct {
	Typename               string `js:"__typename" json:"__typename"`
	SimpleLeafContentVideo `js:"" json:"-"`
}
...
type UserLastContent struct {
	LastContent UserLastContentLastContentLeafContent `js:"lastContent" json:"-"`
}
