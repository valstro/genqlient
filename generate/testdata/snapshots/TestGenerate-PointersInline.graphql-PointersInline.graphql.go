...
type PointersQueryResponse struct {
	...
	User *PointersQueryUser `js:"user" json:"user"`
	// user looks up a user by some stuff.
	//
	// See UserQueryInput for what stuff is supported.
	// If query is null, returns the current user.
	OtherUser    *PointersQueryOtherUser `js:"otherUser" json:"otherUser"`
...
type PointersQueryUser struct {
	...
	EmailsNoPtr []*string   `js:"emailsNoPtr" json:"emailsNoPtr"`
}
