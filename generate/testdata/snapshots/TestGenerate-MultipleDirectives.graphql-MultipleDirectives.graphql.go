...
type MyInput struct {
	...
	Id         *testutil.ID      `js:"id" json:"id,omitempty"`
...
type MyMultipleDirectivesResponse struct {
	...
	User  *MyMultipleDirectivesResponseUser        `js:"user" json:"user"`
	Users []*MyMultipleDirectivesResponseUsersUser `js:"users" json:"users"`
}
...
type __MultipleDirectivesInput struct {
	Query   MyInput           `js:"query" json:"query,omitempty"`
