...
type __getUserInput struct {
	Login string `js:"Login" json:"Login"`
}
...
type getUserResponse struct {
	...
	User getUserUser `js:"user" json:"user"`
}
...
type getUserUser struct {
	...
	TheirName string `js:"theirName" json:"theirName"`
	// Identifies the date and time when the object was created.
	CreatedAt time.Time `js:"createdAt" json:"createdAt"`
}
...
type getViewerResponse struct {
	...
	Viewer getViewerViewerUser `js:"viewer" json:"viewer"`
}
...
type getViewerViewerUser struct {
	// The user's public profile name.
	MyName string `js:"MyName" json:"MyName"`
	// Identifies the date and time when the object was created.
	CreatedAt time.Time `js:"createdAt" json:"createdAt"`
}
