...
[![Go Reference](https://pkg.go.dev/badge/github.com/valstro/genqlient.svg)](https://pkg.go.dev/github.com/valstro/genqlient)
[![Test Status](https://github.com/valstro/genqlient/actions/workflows/go.yml/badge.svg)](https://github.com/valstro/genqlient/actions)
[![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-2.1-4baaaa.svg)](docs/CODE_OF_CONDUCT.md)
[![GoReportcard](https://goreportcard.com/badge/github.com/valstro/genqlient?status.svg)](https://goreportcard.com/report/github.com/valstro/genqlient)
...
You can download and run genqlient the usual way: `go run github.com/valstro/genqlient`.  To set your project up to use genqlient, see the [getting started guide](docs/introduction.md), or the [example](example).  For more complete documentation, see the [docs](docs).
